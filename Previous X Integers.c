...
Note: The first integer has no previous integer. So print only the first integer as the output. 
...
Output Format: The first line contains current integer and X previous integers separated by space(s). 
