...
Output Format: The list of lines contain the integers in descending order with their number of occurrence(s) separated by '-' in each line. 
...
Explanation:    The elements in descending order are 9 2 1 1 1. 
